...
/**
 * A digital government service shortcut, dynamically created by officers.
 * Rendered as a card with a logo (Material icon), name, description and
 * an external link that citizens can open.
 */
public class GovService {
    ...
    private String logoIcon; // Material Symbols icon name used as the service "logo"
